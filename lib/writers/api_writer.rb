module FellowshipOne
  ...
  class ApiWriter
    ...
    def save_object
      ...
      begin
        response = FellowshipOne::admin_request(@url_action, @url_data_path, nil, @url_data_params.to_json)   
    ...
    def delete_object
      ...
      begin
        ...
        response = FellowshipOne::admin_request(:delete, @url_data_delete_path)           
