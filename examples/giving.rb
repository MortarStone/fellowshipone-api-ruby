...
#household_id = '8064919'
#individual_id = '11276697'
individual_id = '11257462'
contribution_list = FellowshipOne::Search.search_for_contributions_by_household_or_individual_id(household_id, individual_id)
